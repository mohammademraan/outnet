                                    ...
                                    <table class="table no-wrap v-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{ asset('admin/assets/images/users/d1.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{ asset('admin/assets/images/users/d2.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{ asset('admin/assets/images/users/d3.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{ asset('admin/assets/images/users/2.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                        ...
                        <li>
                            <div class="message-center chat-scroll">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_8' data-user-id='8'>
                                    ...
                                    <div class="mail-contnet">
                                        <h5 class="message-title">Team Member</h5>
                                        <span class="mail-desc">Pending review</span>
                                        <span class="time">9:02 AM</span>
                                    </div>
                                </a>
                                <!-- Message -->
